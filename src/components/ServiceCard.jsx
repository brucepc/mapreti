...
export default function ServiceCard({ title, description, price, originalPrice }) {
  return (
    <div className="bg-white dark:bg-[#2f1616] rounded-lg p-5 shadow-sm border border-gray-100 dark:border-[#452222] flex flex-col gap-2 hover:shadow-md transition-shadow">
      ...
      <div className="mt-2 text-right flex items-center justify-end gap-2">
        ...
        <span className="inline-block bg-background-light dark:bg-[#3d1d1d] px-3 py-1 rounded-md text-primary font-bold text-sm">
          {price}
        </span>
      </div>
    </div>
